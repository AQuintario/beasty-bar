...
In this game, every player controls a deck of 12 animal cards that get in line to go into a bar.
...
and the game logs of a high number of games are passed to the neural network for training.
...
First item in the To Do list is to change to the Keras library to try more complicated NN models.